...
<div style="background: linear-gradient(90deg, #fff3cd, #ffe066); border: 2px solid #ffc107; border-radius: 8px; padding: 1rem 1.5rem; margin-bottom: 1.5rem; text-align: center;">
  <span style="font-size: 1.15rem; font-weight: 600; color: #856404;">
    Submission deadline approaching! <mark style="background: #ffc107; padding: 0.2rem 0.5rem; border-radius: 4px;">Abstracts are due January 16</mark>
  </span>
  <br>
  <a href="https://forms.cloud.microsoft/r/Rq9Z1Kdtk8" style="display: inline-block; margin-top: 0.6rem; background: #294a70; color: white; padding: 0.5rem 1rem; border-radius: 5px; text-decoration: none; font-weight: 500;">Submit Your Abstract</a>
</div>
...
Anyone interested in bioinformatics, computational genomics, or life sciences research is welcome to attend our virtual seminars. **Please fill out [this form](https://forms.cloud.microsoft/r/MtLwnQnUUT) to be added to our email list so you never miss a seminar.**
